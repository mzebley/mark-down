...
| `--zbk-select-indicator-ink` | `{app.ink-muted}` | color | — | Color of the drawn chevron indicator. |
| `--zbk-select-indicator-ink-disabled` | `{disabled.ink}` | color | — | Chevron color when disabled. |
